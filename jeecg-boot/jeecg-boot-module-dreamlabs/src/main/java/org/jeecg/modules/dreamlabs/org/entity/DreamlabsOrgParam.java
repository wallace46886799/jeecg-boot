package org.jeecg.modules.dreamlabs.org.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="dreamlabs_org对象", description="金融机构表")
@Data
@TableName("dreamlabs_org_param")
public class DreamlabsOrgParam implements Serializable {
