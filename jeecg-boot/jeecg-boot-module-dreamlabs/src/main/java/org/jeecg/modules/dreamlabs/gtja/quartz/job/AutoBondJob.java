 ...
 */
@Slf4j
public class AutoBondJob extends AbstractGtjaJob {


	@Override
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		log.info("==============》自动申购可转债开始，日期:{}，时间:{}", DateUtils.getDate("yyyy-MM-dd"), DateUtils.now());
		try {
		...
		log.info("《==============自动申购可转债结束，日期:{}，时间:{}", DateUtils.getDate("yyyy-MM-dd"), DateUtils.now());
