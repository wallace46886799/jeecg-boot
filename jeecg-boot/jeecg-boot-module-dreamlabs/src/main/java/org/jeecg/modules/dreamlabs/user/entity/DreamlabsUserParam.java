package org.jeecg.modules.dreamlabs.user.entity;
 ...
 * @Version: V1.0
 */
@ApiModel(value="dreamlabs_user对象", description="用户表")
@Data
@TableName("dreamlabs_user_param")
public class DreamlabsUserParam implements Serializable {
